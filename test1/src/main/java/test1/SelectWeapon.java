...
public class SelectWeapon extends JFrame {
	...
	public SelectWeapon(String idPlayer) {
		...
		JLabel arma = new JLabel("Selecciona un arma");
		...
		JLabel armadura = new JLabel("Selecciona una armadura");
		...
		JLabel ataque = new JLabel("Ataque = 0");
		...
		JLabel tipoArma = new JLabel("Tipo = Normal");
		...
		JLabel tipoArmadura = new JLabel("Tipo = Normal");
		...
		JLabel velocidadArmadura = new JLabel("Velocidad = 0");
                ...
                if (!arg0.getValueIsAdjusting()) {
                  ...
                  for (int i = 0; i < weapons.size(); i++) {
                	  if (weapons.get(i).get("weaponName").textValue().equals(listaArmas.getSelectedValue().toString())) {
                		  ataque.setText("Ataque = " + weapons.get(i).get("baseDamage").intValue());
                		  tipoArma.setText("Tipo = " + weapons.get(i).get("damageType").textValue());
                	  }
                  }
                }
            }
                ...
                if (!arg0.getValueIsAdjusting()) {
                  ...
                  for (int i = 0; i < armors.size(); i++) {
                	  if (armors.get(i).get("armorName").textValue().equals(listaArmaduras.getSelectedValue().toString())) {
                		  defensa.setText("Defensa = " + armors.get(i).get("baseDefense").intValue());
                		  tipoArmadura.setText("Tipo = " + armors.get(i).get("armorType").textValue());
                		  velocidadArmadura.setText("Velocidad = " + armors.get(i).get("baseSpeed").intValue());
                	  }
                  }
                }
            }
	...
	private Map<String, ImageIcon> createImageMapArmas(String[] stringArray) {
        ...
        try {
            ...
            map.put("Sylph Sword", new ImageIcon(new URL("http://i.stack.imgur.com/UvHN4.png")));
